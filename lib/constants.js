...
export const STORAGE_KEYS = {
  ...
  updateDismissed:'jt_update_dismissed'  // storage.session：已忽略的版本号
};

export const UPDATE_REPO_API = 'https://api.github.com/repos/Zheyi-D/job-hub/releases/latest';
export const UPDATE_CHECK_INTERVAL_MIN = 360;
